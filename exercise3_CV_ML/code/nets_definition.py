...
def FCN_Seg(self, is_training=True):
    ...
    if self.configuration == 1:
        ...
        # current_up5
        current_up5 = TransitionUp_elu(x, 120, 16,  name='')
    ...
    if self.configuration == 2:
        ...
        current_up3 = TransitionUp_elu(x, 120, 2, name='')
        current_up3 = Concat_layers(DB4_skip_connection, current_up3,nm='')
        current_up3 = Convolution(current_up3, 256, 3, name='')
        ...
        current_up3 = TransitionUp_elu(current_up3, 120, 8, name='')
    ...
    if self.configuration == 3:
        ...
        # but that also fuse the upsampled features with the corresponding skip connection (DB4_skip_connection)
        # through concatenation. After that use a convolution with kernel 3x3 to produce 256 output feature maps 
        current_up4 = TransitionUp_elu(x, 120, 2, name='')
        current_up4 = Concat_layers(DB4_skip_connection, current_up4,nm='')
        current_up4 = Convolution(current_up4, 256, 3, name='')
        ...
        current_up4 = TransitionUp_elu(current_up4, 120, 2, name='')
        current_up4 = crop(current_up4, DB3_skip_connection)    
        current_up4 = Concat_layers(DB3_skip_connection, current_up4,nm='')
        current_up4 = Convolution(current_up4, 160, 3, name='')
        ...
        current_up4 = TransitionUp_elu(current_up4, 120, 4, name='')
    ...
    if self.configuration == 4:
        ...
        # but that also fuse the upsampled features with the corresponding skip connection (DB4_skip_connection)
        # through concatenation. After that use a convolution with kernel 3x3 to produce 256 output feature maps 
        current_up5 = TransitionUp_elu(x, 120, 2, name='')
        current_up5 = Concat_layers(DB4_skip_connection, current_up5,nm='')
        current_up5 = Convolution(current_up5, 256, 3, name='')
       
        # TODO (4.2) - Repeat TODO(4.1) now producing 160 output feature maps and fusing the upsampled features 
        # with the corresponding skip connection (DB3_skip_connection) through concatenation.
        current_up5 = TransitionUp_elu(current_up5, 120, 2, name='')
        current_up5 = crop(current_up5, DB3_skip_connection)    
        current_up5 = Concat_layers(DB3_skip_connection, current_up5,nm='')
        current_up5 = Convolution(current_up5, 160, 3, name='')
        ...
        current_up5 = TransitionUp_elu(current_up5, 120, 2, name='')
        current_up5 = Concat_layers(DB2_skip_connection, current_up5,nm='')
        current_up5 = Convolution(current_up5, 96, 3, name='')
